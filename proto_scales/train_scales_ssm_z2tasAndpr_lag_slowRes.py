...
import torch
import proto_scales.ssm_model.scales_ssm_z2tasAndpr_laggingGMT_slowResevoir as scales_ssm_z2pr
import numpy as np
import pickle
import argparse
import pandas as pd
...
if __name__ == "__main__":
    ...
    try:
        model, y_scaler, u_scaler,pr_scaler = scales_ssm_z2pr.run_train(tas, pr,u, context_len=100, z_dim=64,rnn_hidden=256,horizon=100,
            use_linear_model=use_linear_model,epochs=epochs,batch_size=250,alpha_max=1, resevoir_dim=args.reservoir)
    except Exception:
