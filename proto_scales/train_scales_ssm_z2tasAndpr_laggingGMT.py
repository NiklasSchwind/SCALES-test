...
import torch
import proto_scales.ssm_model.scales_ssm_z2tasAndpr_laggingGMT as scales_ssm_z2pr
import numpy as np
import pickle
import argparse
import pandas as pd
...
if __name__ == "__main__":
    ...
    try:
        model, y_scaler, u_scaler,pr_scaler = scales_ssm_z2pr.run_train(tas, pr,u, context_len=700, z_dim=64,rnn_hidden=256,horizon=300, 
