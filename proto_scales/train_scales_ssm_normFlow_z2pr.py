...
import torch
import proto_scales.ssm_model.scales_ssm_z2pr_norm_flow as scales_ssm_z2pr
import numpy as np
import pickle
...
TRAIN_SCENARIOS = [ 'ssp585','1pctco2','ssp245']#,'ssp534-over','flat10cdrincspinoff','ssp126','flat10zecincspinoff', 'flat10cdrincspinoff']#,'abrupt4xco2','ssp119','ssp460','ssp370']
N = 200
